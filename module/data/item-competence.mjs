...
export default class MyriadSystemItemCompetence extends MyriadSystemItemBase {
  ...
  static defineSchema() {
    ...
    // Add competence-specific fields
    const competenceSchema = {
      ...
      isUnique: new fields.BooleanField({ initial: false }) // Whether this is a unique ability vs. a standard competence
    };

    return foundry.utils.mergeObject(baseSchema, competenceSchema);
  }
